...
// FileBasedMatchRepository manages storage of Match instances in JSON files
type FileBasedMatchRepository struct {
	path  string
	files []string
}

// Store serializes matches to a JSON file and records the file path
...
// Clear deletes all stored JSON files
